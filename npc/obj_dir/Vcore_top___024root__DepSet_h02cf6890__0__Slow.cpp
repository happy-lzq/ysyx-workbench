...
#endif
            VL_FATAL_MT("vsrc/core_top.v", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vcore_top___024root___ctor_var_reset(Vcore_top___024root* vlSelf) {
    ...
    vlSelf->core_top__DOT__imm_out = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 18181957587814231374ull);
    vlSelf->core_top__DOT__mem_addr = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10245757983830322573ull);
    vlSelf->core_top__DOT__mem_wdata_raw = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10359699498610592981ull);
    vlSelf->core_top__DOT__csr_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8226085165328711824ull);
    vlSelf->core_top__DOT__trap_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16034318904267310537ull);
    vlSelf->core_top__DOT__is_ebreak_eff = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10443977718903165234ull);
    vlSelf->core_top__DOT__if_id_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1833943607983303116ull);
    vlSelf->core_top__DOT__if_id_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15483885344133485466ull);
    vlSelf->core_top__DOT__if_id_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17946521912242836228ull);
    vlSelf->core_top__DOT__if_id_inst = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14675359089469552070ull);
    vlSelf->core_top__DOT__id_ex_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11052505132808885313ull);
    vlSelf->core_top__DOT__id_ex_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 13579310545552683172ull);
    vlSelf->core_top__DOT__id_ex_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5768187080349828560ull);
    vlSelf->core_top__DOT__id_ex_inst = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16907739402955030484ull);
    vlSelf->core_top__DOT__id_ex_rs1_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 6460823729704029996ull);
    vlSelf->core_top__DOT__id_ex_rs2_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 16937332565983141202ull);
    vlSelf->core_top__DOT__id_ex_rd_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 17693840341860463759ull);
    vlSelf->core_top__DOT__id_ex_rs1_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1275627823489757784ull);
    vlSelf->core_top__DOT__id_ex_rs2_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1128289692877582144ull);
    vlSelf->core_top__DOT__id_ex_imm_out = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14383256195058551583ull);
    vlSelf->core_top__DOT__id_ex_ex_ctrl = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 13367104110591270316ull);
    vlSelf->core_top__DOT__id_ex_mem_ctrl = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 16034905274806150720ull);
    vlSelf->core_top__DOT__id_ex_wb_ctrl = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16085674110695867736ull);
    vlSelf->core_top__DOT__id_ex_csr_ctrl = VL_SCOPED_RAND_RESET_Q(49, __VscopeHash, 13205808858863965150ull);
    vlSelf->core_top__DOT__id_ex_sys_ctrl = VL_SCOPED_RAND_RESET_Q(35, __VscopeHash, 6492473771277792279ull);
    vlSelf->core_top__DOT__ex_mem_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16888572511929900024ull);
    vlSelf->core_top__DOT__ex_mem_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6494384235944491490ull);
    vlSelf->core_top__DOT__ex_mem_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16340707457621894813ull);
    vlSelf->core_top__DOT__ex_mem_inst = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17514989593758771098ull);
    vlSelf->core_top__DOT__ex_mem_rd_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 4662004803366271198ull);
    vlSelf->core_top__DOT__ex_mem_alu_result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 8322194935095076632ull);
    vlSelf->core_top__DOT__ex_mem_rs2_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6428444471628165648ull);
    vlSelf->core_top__DOT__ex_mem_csr_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14632859876173629378ull);
    vlSelf->core_top__DOT__ex_mem_csr_wdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 17654807205403048658ull);
    vlSelf->core_top__DOT__ex_mem_mem_ctrl = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 8500093357482291537ull);
    vlSelf->core_top__DOT__ex_mem_wb_ctrl = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 959250757890577691ull);
    vlSelf->core_top__DOT__ex_mem_csr_ctrl = VL_SCOPED_RAND_RESET_Q(49, __VscopeHash, 13418475489384498795ull);
    vlSelf->core_top__DOT__ex_mem_sys_ctrl = VL_SCOPED_RAND_RESET_Q(35, __VscopeHash, 12336927084669950941ull);
    vlSelf->core_top__DOT__mem_wb_valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 14181803924461712592ull);
    vlSelf->core_top__DOT__mem_wb_pc = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 430415005858296244ull);
    vlSelf->core_top__DOT__mem_wb_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14352593029298495856ull);
    vlSelf->core_top__DOT__mem_wb_inst = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 18152264081354403042ull);
    vlSelf->core_top__DOT__mem_wb_rd_addr = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 14205445064350589676ull);
    vlSelf->core_top__DOT__mem_wb_alu_result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2450425236820778566ull);
    vlSelf->core_top__DOT__mem_wb_mem_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 2637554819387749923ull);
    vlSelf->core_top__DOT__mem_wb_csr_rdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 14760071466501778538ull);
    vlSelf->core_top__DOT__mem_wb_csr_wdata = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16196464123571477069ull);
    vlSelf->core_top__DOT__mem_wb_wb_ctrl = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1145473509344867632ull);
    vlSelf->core_top__DOT__mem_wb_csr_ctrl = VL_SCOPED_RAND_RESET_Q(49, __VscopeHash, 4959855770258501472ull);
    vlSelf->core_top__DOT__mem_wb_sys_ctrl = VL_SCOPED_RAND_RESET_Q(35, __VscopeHash, 4314630378104848195ull);
    vlSelf->core_top__DOT__u_if_stage__DOT__pc_next = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 6969335522121334582ull);
    vlSelf->core_top__DOT__u_if_stage__DOT__trap_enter = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1674832413622293103ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__target_sum = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5096522046944715602ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__alu_op = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 3130348757020595275ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__alu_src_a = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16048432458971021260ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__alu_src_b = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 8982013318725917621ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__br_type = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 1869144179287123956ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__mem_read = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9012241894775018089ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__mem_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9754344960415020940ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__lsu_type = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 6566427648169992711ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__reg_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8512835541523679349ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__reg_wdata_src = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 13709207989918637746ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__csr_read = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17517906150066987941ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__csr_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17924658077432040037ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__csr_imm = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4438956164102824299ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__csr_op = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 16960877721220372487ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__pc_sel = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 1441658075365010323ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__trap_enter_int = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9573713536017370752ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__is_ebreak_int = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10587622575021266445ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__mret_int = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4548840938299184412ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__is_jal_int = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6972388161990856497ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__is_jalr_int = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9018723129279025450ull);
    vlSelf->core_top__DOT__u_id_stage__DOT__u_control__DOT__trap_code_int = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16614197994151026493ull);
    ...
    vlSelf->core_top__DOT__u_mem_stage__DOT__mem_read = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16032344176842186758ull);
    vlSelf->core_top__DOT__u_mem_stage__DOT__mem_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18014597236950336022ull);
    ...
    vlSelf->core_top__DOT__u_csr__DOT__csr_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17769524059831436485ull);
    vlSelf->core_top__DOT__u_csr__DOT__trap_enter = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16366977940590268287ull);
    vlSelf->core_top__DOT__u_csr__DOT__mret = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15496226626249430485ull);
    vlSelf->core_top__DOT__u_csr__DOT__trap_code = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16704571279539623627ull);
    ...
    vlSelf->core_top__DOT__u_csr__DOT____VdfgRegularize_h8136f0d8_0_0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8235429084404480885ull);
