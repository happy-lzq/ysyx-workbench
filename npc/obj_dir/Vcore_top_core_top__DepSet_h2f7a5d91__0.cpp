...
VL_INLINE_OPT void Vcore_top_core_top___ico_sequent__TOP__core_top__0(Vcore_top_core_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcore_top_core_top___ico_sequent__TOP__core_top__0\n"); );
...
VL_INLINE_OPT void Vcore_top_core_top___nba_sequent__TOP__core_top__1(Vcore_top_core_top* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vcore_top_core_top___nba_sequent__TOP__core_top__1\n"); );
    Vcore_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    // Body
    if (vlSelfRef.__VdlySet__u_mem_stage__DOT__mem__v0) {
        vlSelfRef.__PVT__u_mem_stage__DOT__mem[vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v0] 
            = ((0xffffff00U & vlSelfRef.__PVT__u_mem_stage__DOT__mem
                [vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v0]) 
               | (IData)(vlSelfRef.__VdlyVal__u_mem_stage__DOT__mem__v0));
    }
    if (vlSelfRef.__VdlySet__u_mem_stage__DOT__mem__v1) {
        vlSelfRef.__PVT__u_mem_stage__DOT__mem[vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v1] 
            = ((0xffff00ffU & vlSelfRef.__PVT__u_mem_stage__DOT__mem
                [vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v1]) 
               | ((IData)(vlSelfRef.__VdlyVal__u_mem_stage__DOT__mem__v1) 
                  << 8U));
    }
    if (vlSelfRef.__VdlySet__u_mem_stage__DOT__mem__v2) {
        vlSelfRef.__PVT__u_mem_stage__DOT__mem[vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v2] 
            = ((0xff00ffffU & vlSelfRef.__PVT__u_mem_stage__DOT__mem
                [vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v2]) 
               | ((IData)(vlSelfRef.__VdlyVal__u_mem_stage__DOT__mem__v2) 
                  << 0x10U));
    }
    if (vlSelfRef.__VdlySet__u_mem_stage__DOT__mem__v3) {
        vlSelfRef.__PVT__u_mem_stage__DOT__mem[vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v3] 
            = ((0xffffffU & vlSelfRef.__PVT__u_mem_stage__DOT__mem
                [vlSelfRef.__VdlyDim0__u_mem_stage__DOT__mem__v3]) 
               | ((IData)(vlSelfRef.__VdlyVal__u_mem_stage__DOT__mem__v3) 
                  << 0x18U));
    }
    vlSelfRef.__PVT__pc = ((IData)(vlSymsp->TOP.rst)
                            ? 0x80000000U : vlSelfRef.__PVT__u_if_stage__DOT__pc_next);
