...
VL_INLINE_OPT void Vcore_top___024root___nba_sequent__TOP__0(Vcore_top___024root* vlSelf) {
    ...
    IData/*24:0*/ __VdlyDim0__core_top__DOT__u_mem_stage__DOT__dmem__v0;
    ...
    IData/*24:0*/ __VdlyDim0__core_top__DOT__u_mem_stage__DOT__dmem__v1;
    ...
    IData/*24:0*/ __VdlyDim0__core_top__DOT__u_mem_stage__DOT__dmem__v2;
    ...
    IData/*24:0*/ __VdlyDim0__core_top__DOT__u_mem_stage__DOT__dmem__v3;
    ...
    if (((IData)(vlSelfRef.core_top__DOT__mem_write) 
        ...
        if (vlSelfRef.core_top__DOT__trap_enter) {
            ...
            if (vlSelfRef.core_top__DOT__csr_write) {
                if (((((((((0x300U == (IData)(vlSelfRef.core_top__DOT__csr_addr)) 
                         ...
                         | (0x342U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                        | (0x344U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                       | (0x304U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                      | (0x343U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                     | (0x340U == (IData)(vlSelfRef.core_top__DOT__csr_addr)))) {
                    if ((0x300U != (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                        if ((0x305U != (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                            if ((0x341U != (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                                if ((0x342U != (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                                    if ((0x344U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                                        __Vdly__core_top__DOT__u_csr__DOT__csr_mip 
    ...
    if (vlSelfRef.rst) {
        ...
        if ((1U & (~ (IData)(vlSelfRef.core_top__DOT__trap_enter)))) {
            if ((1U & (~ (IData)(vlSelfRef.core_top__DOT__mret)))) {
                if (vlSelfRef.core_top__DOT__csr_write) {
                    if ((1U & (~ ((((((((0x300U == (IData)(vlSelfRef.core_top__DOT__csr_addr)) 
                                        | (0x305U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                                       | (0x341U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                                      | (0x342U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                                     | (0x344U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) 
                        ...
                        } else if ((0xb80U == (IData)(vlSelfRef.core_top__DOT__csr_addr))) {
                            __Vdly__core_top__DOT__u_csr__DOT__mcycle_64 
    ...
    vlSelfRef.core_top__DOT__u_mem_stage__DOT__in_pmem 
        = ((0x80000000U <= vlSelfRef.core_top__DOT__jump_jalr) 
           & (0x88000000U > vlSelfRef.core_top__DOT__jump_jalr));
    Vcore_top___024unit____Vdpiimwrap_dpi_mmio_read_TOP____024unit(vlSelfRef.core_top__DOT__jump_jalr, vlSelfRef.__Vfunc_dpi_mmio_read__0__Vfuncout);
