...
#endif
            VL_FATAL_MT("vsrc/core_top.v", 3, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("vsrc/core_top.v", 3, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("vsrc/core_top.v", 3, "", "Active region did not converge.");
            }
