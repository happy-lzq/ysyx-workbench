...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.seg4 = 0xfdU;
    vlSelfRef.seg5 = 0xfdU;
}
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__press_count = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 3711570070151465725ull);
    vlSelf->top__DOT__valid = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18441342033171973176ull);
    vlSelf->top__DOT__released_data = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 133380830978071509ull);
    ...
    vlSelf->top__DOT__cola_timer = VL_SCOPED_RAND_RESET_I(24, __VscopeHash, 3290222744773053087ull);
    vlSelf->top__DOT__refund_timer = VL_SCOPED_RAND_RESET_I(24, __VscopeHash, 3574333180054094101ull);
    ...
    vlSelf->top__DOT__count_tens = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 5029308733609392689ull);
    vlSelf->top__DOT__count_units = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 1406537069101703162ull);
    ...
    vlSelf->top__DOT__u_ps2__DOT__prev_scancode = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 13882008382842880392ull);
    ...
    vlSelf->__Vdly__top__DOT__press_count = VL_SCOPED_RAND_RESET_I(7, __VscopeHash, 1126234259751092694ull);
    vlSelf->__Vdly__top__DOT__u_ps2__DOT__prev_scancode = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 5604742486230091984ull);
