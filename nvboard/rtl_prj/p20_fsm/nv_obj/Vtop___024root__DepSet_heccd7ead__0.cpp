...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.led = (((IData)(vlSelfRef.rst_n) << 0xfU) 
                     | (((0U < vlSelfRef.top__DOT__refund_timer) 
                         << 1U) | ((4U == (IData)(vlSelfRef.top__DOT__u_com_fsm__DOT__state)) 
                                   | (0U < vlSelfRef.top__DOT__cola_timer))));
}
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*23:0*/ __Vdly__top__DOT__cola_timer;
    __Vdly__top__DOT__cola_timer = 0;
    IData/*23:0*/ __Vdly__top__DOT__refund_timer;
    __Vdly__top__DOT__refund_timer = 0;
    // Body
    vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode 
        = vlSelfRef.top__DOT__u_ps2__DOT__prev_scancode;
    vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__count = vlSelfRef.top__DOT__u_ps2__DOT__count;
    __Vdly__top__DOT__cola_timer = vlSelfRef.top__DOT__cola_timer;
    vlSelfRef.__Vdly__top__DOT__press_count = vlSelfRef.top__DOT__press_count;
    vlSelfRef.__Vdly__top__DOT__f0_seen = vlSelfRef.top__DOT__f0_seen;
    __Vdly__top__DOT__refund_timer = vlSelfRef.top__DOT__refund_timer;
    if (vlSelfRef.rst_n) {
        if (vlSelfRef.top__DOT__po_cola) {
            __Vdly__top__DOT__cola_timer = 0x989680U;
        } else if ((0U < vlSelfRef.top__DOT__cola_timer)) {
            __Vdly__top__DOT__cola_timer = (0xffffffU 
                                            & (vlSelfRef.top__DOT__cola_timer 
                                               - (IData)(1U)));
        }
        if (vlSelfRef.top__DOT__po_money) {
            __Vdly__top__DOT__refund_timer = 0x989680U;
        } else if ((0U < vlSelfRef.top__DOT__refund_timer)) {
            __Vdly__top__DOT__refund_timer = (0xffffffU 
                                              & (vlSelfRef.top__DOT__refund_timer 
                                                 - (IData)(1U)));
        }
        ...
        if (((IData)(vlSelfRef.top__DOT__system_enable) 
            ...
            if ((0x3aU == (IData)(vlSelfRef.top__DOT__released_data))) {
                vlSelfRef.top__DOT__one_pulse = 1U;
            }
            if ((0x3aU != (IData)(vlSelfRef.top__DOT__released_data))) {
                if ((0x31U == (IData)(vlSelfRef.top__DOT__released_data))) {
                    vlSelfRef.top__DOT__half_pulse = 1U;
                }
            }
        }
    } else {
        __Vdly__top__DOT__cola_timer = 0U;
        __Vdly__top__DOT__refund_timer = 0U;
        vlSelfRef.top__DOT__one_pulse = 0U;
        vlSelfRef.top__DOT__half_pulse = 0U;
    }
    vlSelfRef.top__DOT__cola_timer = __Vdly__top__DOT__cola_timer;
    vlSelfRef.top__DOT__refund_timer = __Vdly__top__DOT__refund_timer;
}
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__3(Vtop___024root* vlSelf) {
    ...
    if (vlSelfRef.rst_n) {
        ...
        if (((IData)(vlSelfRef.top__DOT__system_enable) 
            ...
            if ((0x3aU != (IData)(vlSelfRef.top__DOT__released_data))) {
                if ((0x31U != (IData)(vlSelfRef.top__DOT__released_data))) {
                    if ((0x29U == (IData)(vlSelfRef.top__DOT__released_data))) {
        ...
        if (vlSelfRef.top__DOT__key_release_pulse) {
            if ((0x5aU == (IData)(vlSelfRef.top__DOT__released_data))) {
                vlSelfRef.top__DOT__system_enable = 1U;
            } else if ((0x76U == (IData)(vlSelfRef.top__DOT__released_data))) {
        ...
        if (vlSelfRef.top__DOT__valid) {
            if ((0xf0U == (IData)(vlSelfRef.top__DOT__scancode))) {
                ...
                vlSelfRef.top__DOT__released_data = vlSelfRef.top__DOT__scancode;
        ...
        vlSelfRef.__Vdly__top__DOT__f0_seen = 0U;
        vlSelfRef.top__DOT__key_release_pulse = 0U;
        vlSelfRef.top__DOT__released_data = 0U;
    }
    ...
    if (vlSelfRef.rst_n) {
        ...
        if ((IData)((4U == (6U & (IData)(vlSelfRef.top__DOT__u_ps2__DOT__ps2_clk_sync))))) {
            if ((0xaU == (IData)(vlSelfRef.top__DOT__u_ps2__DOT__count))) {
                if (VL_UNLIKELY(((((~ (IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer)) 
                    ...
                    VL_WRITEF_NX("receive %x\n",0,8,
                                 (0xffU & ((IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer) 
                                           >> 1U)));
                    if ((0xe0U != (0xffU & ((IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer) 
                                            >> 1U)))) {
                        if ((0xf0U == (0xffU & ((IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer) 
                                                >> 1U)))) {
                            vlSelfRef.__Vdly__top__DOT__press_count 
                                = (0x7fU & ((IData)(1U) 
                                            + (IData)(vlSelfRef.top__DOT__press_count)));
                            vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode 
                                = (0xffU & ((IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer) 
                                            >> 1U));
                        } else if (((0xffU & ((IData)(vlSelfRef.top__DOT__u_ps2__DOT__buffer) 
                                              >> 1U)) 
                                    != (IData)(vlSelfRef.top__DOT__u_ps2__DOT__prev_scancode))) {
                            if ((0xf0U != (IData)(vlSelfRef.top__DOT__u_ps2__DOT__prev_scancode))) {
                                vlSelfRef.__Vdly__top__DOT__press_count 
                                    = (0x7fU & ((IData)(1U) 
                                                + (IData)(vlSelfRef.top__DOT__press_count)));
                                vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode 
                                ...
                                vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode = 0U;
                            }
                        }
                    }
                ...
                vlSelfRef.top__DOT__u_ps2__DOT____Vlvbound_h77389395__0 
                    = vlSelfRef.ps2_data;
                if (VL_LIKELY(((9U >= (IData)(vlSelfRef.top__DOT__u_ps2__DOT__count))))) {
        ...
        vlSelfRef.__Vdly__top__DOT__press_count = 0U;
        vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode = 0U;
        vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__count = 0U;
        vlSelfRef.top__DOT__valid = 0U;
        vlSelfRef.top__DOT__scancode = 0U;
    }
    vlSelfRef.top__DOT__u_ps2__DOT__prev_scancode = vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__prev_scancode;
    vlSelfRef.top__DOT__u_ps2__DOT__count = vlSelfRef.__Vdly__top__DOT__u_ps2__DOT__count;
    vlSelfRef.top__DOT__press_count = vlSelfRef.__Vdly__top__DOT__press_count;
    if (vlSelfRef.top__DOT__system_enable) {
        __Vtableidx9 = (0xfU & VL_DIV_III(7, (IData)(vlSelfRef.top__DOT__press_count), (IData)(0xaU)));
        __Vtableidx10 = (0xfU & VL_MODDIV_III(7, (IData)(vlSelfRef.top__DOT__press_count), (IData)(0xaU)));
    } else {
        __Vtableidx9 = 0xaU;
        __Vtableidx10 = 0xaU;
    }
    vlSelfRef.top__DOT__count_tens = Vtop__ConstPool__TABLE_h51079ee3_0
        [__Vtableidx9];
    vlSelfRef.top__DOT__count_units = Vtop__ConstPool__TABLE_h51079ee3_0
        [__Vtableidx10];
    vlSelfRef.seg7 = (0xffU & (~ ((IData)(vlSelfRef.top__DOT__count_tens) 
                                  << 1U)));
    vlSelfRef.seg6 = (0xffU & (~ ((IData)(vlSelfRef.top__DOT__count_units) 
                                  << 1U)));
}
