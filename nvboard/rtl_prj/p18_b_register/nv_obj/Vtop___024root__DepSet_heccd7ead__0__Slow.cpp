...
#endif
            VL_FATAL_MT("p18_b_register/vsrc/top.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->shmat = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 12328895438945987413ull);
    vlSelf->l_r = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 586720140384520536ull);
    vlSelf->a_l = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13145768451483891894ull);
    ...
    vlSelf->top__DOT__u_b_shifter__DOT__al = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 17825664263649880596ull);
}
