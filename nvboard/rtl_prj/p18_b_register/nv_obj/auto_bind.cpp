...
void nvboard_bind_all_pins(Vtop* top) {
	nvboard_bind_pin( &top->shmat, 3, SW2, SW1, SW0);
	nvboard_bind_pin( &top->l_r, 1, BTNU);
	nvboard_bind_pin( &top->a_l, 1, BTNC);
	nvboard_bind_pin( &top->din, 8, SW15, SW14, SW13, SW12, SW11, SW10, SW9, SW8);
