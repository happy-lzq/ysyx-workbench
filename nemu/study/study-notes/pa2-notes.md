...
- [PA2 专题：小游戏（字符蛇）软硬协同实验报告](#sec-pa2-minigame)
  - [1. 实验目标与验收标准](#sec-minigame-01)
  - [2. 系统架构与数据结构设计](#sec-minigame-02)
  - [3. 执行逻辑与关键函数链路](#sec-minigame-03)
  - [4. 帧刷新系统设计（核心）](#sec-minigame-04)
  - [5. 硬件协同、问题定位与最终结论](#sec-minigame-05)
<a id="sec-softlink"></a>
